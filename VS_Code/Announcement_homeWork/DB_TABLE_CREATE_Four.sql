...
-- 주관적 (subjective)
 ...
 INSERT INTO jobel VALUES('데이터베이스 관리자', '현재 DB 관리자는 통계적으로도 전망이 매우 밝다고 생각함', 1);
 INSERT INTO jobel VALUES('경찰', '경찰은 공무원이기에 혜택이 좋아 이 직업이 된다면 명예와 혜택이 같이 따른다', 2);
 INSERT INTO jobel VALUES('교사', '선생님 또한 교육 공무원이기에 일에 맞는다면 매우 괜찮은 직업이 될 것이다.', 3);
 INSERT INTO jobel VALUES('소방관', '소방사는 위험한 일들이 많기에 국가의 자랑이라 해도 무방할 정도로 존경스런 직업중 하나 이다.', 3);
 INSERT INTO jobel VALUES('판사', '죄인을 판결하는 직업, 다들 알다시피 연봉이 어마무시하다.', 1);
